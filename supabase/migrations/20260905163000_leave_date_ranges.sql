create or replace function public.register_leave_range(
...
create or replace function public.delete_leave_range(
  selected_employee_id uuid,
  login_username text,
  login_password text,
  selected_start_date date,
...
grant execute on function public.register_leave_range(uuid, text, text, date, date) to anon, authenticated;
grant execute on function public.delete_leave_range(uuid, text, text, date, date) to anon, authenticated;
